...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../src/macro.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/network.js":[function(require,module,exports) {
"use strict";
...
var put = function put(path, data, handler) {
  if (waiting) return;
  waiting = true;

  _axios.default.put(path, data).then(function (response) {
    waiting = false;
    handler(response);
  }).catch(function (error) {
    waiting = false;
...
},{"axios":"../../node_modules/axios/index.js"}],"../src/operation.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Operation(props) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(Operation).call(this, props));
  }
  ...
  _createClass(Operation, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "op"
      }, _react.default.createElement(OperationQuery, null));
    }
  }]);
...
function (_React$Component2) {
  _inherits(OperationQuery, _React$Component2);

  function OperationQuery(props) {
    var _this;

    _classCallCheck(this, OperationQuery);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(OperationQuery).call(this, props));
    _this.state = {
      active: false,
      data: []
    };
  ...
  _createClass(OperationQuery, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      window.eventMgr.subscribe(_macro.MacroEvent.UpdateData, this, this.onRun.bind(this));
    }
  }, {
    key: "componentWillUnmount",
    value: function componentWillUnmount() {
      window.eventMgr.unsubscribe(_macro.MacroEvent.UpdateData, this);
    }
  }, {
    key: "render",
    value: function render() {
      var items = [];
      items.push(_react.default.createElement(DataItemTitle, {
        key: -1
      }));
      this.state.data.forEach(function (d, idx) {
        items.push(_react.default.createElement(DataItem, {
          key: idx,
          data: d
        }));
      });
      return _react.default.createElement("div", {
        ...
        className: "face"
      }, _react.default.createElement("p", null, "Query"), _react.default.createElement("button", {
        onClick: this.onRun.bind(this)
      }, "Run")), this.state.active ? _react.default.createElement("div", {
        className: "result"
      }, items) : null);
    }
  }, {
    ...
    value: function onRun() {
      ...
      _network.default.get('/api/query', handler);
    }
  }]);
...
function (_React$Component3) {
  _inherits(DataItemTitle, _React$Component3);

  function DataItemTitle() {
    _classCallCheck(this, DataItemTitle);

    return _possibleConstructorReturn(this, _getPrototypeOf(DataItemTitle).apply(this, arguments));
  }

  _createClass(DataItemTitle, [{
    key: "render",
    value: function render() {
      return _react.default.createElement("div", {
        className: "dataitem datatitle"
      }, _react.default.createElement("p", null, "KEY"), _react.default.createElement("p", null, "COLOR"), _react.default.createElement("p", null, "DOCTYPE"), _react.default.createElement("p", null, "MAKE"), _react.default.createElement("p", null, "MODEL"), _react.default.createElement("p", null, "OWNER"));
    }
  }]);
...
function (_React$Component4) {
  _inherits(DataItem, _React$Component4);
  ...
  function DataItem(props) {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(DataItem).call(this, props));
    _this3.state = {
      showModify: false
    };
    return _this3;
  ...
  _createClass(DataItem, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        className: "dataitem-root"
      }, _react.default.createElement("div", {
        className: "dataitem",
        onClick: this.onClick.bind(this)
      }, _react.default.createElement("p", null, data.Key), _react.default.createElement("p", null, data.Record.color), _react.default.createElement("p", null, data.Record.docType), _react.default.createElement("p", null, data.Record.make), _react.default.createElement("p", null, data.Record.model), _react.default.createElement("p", null, data.Record.owner)), this.state.showModify ? _react.default.createElement(ModifyPanel, {
        data: data
      }) : null);
    }
  }, {
...
function (_React$Component5) {
  _inherits(ModifyPanel, _React$Component5);

  function ModifyPanel(props) {
    var _this4;

    _classCallCheck(this, ModifyPanel);

    _this4 = _possibleConstructorReturn(this, _getPrototypeOf(ModifyPanel).call(this, props));
    _this4.refKey = _react.default.createRef();
    _this4.refCol = _react.default.createRef();
    _this4.refDoc = _react.default.createRef();
    _this4.refMake = _react.default.createRef();
    _this4.refModel = _react.default.createRef();
    _this4.refOwner = _react.default.createRef();
    return _this4;
  }

  _createClass(ModifyPanel, [{
    key: "componentDidMount",
    value: function componentDidMount() {
    ...
    value: function render() {
      var data = this.props.data;
      return _react.default.createElement("div", {
        className: "modify-root"
      }, _react.default.createElement("div", {
        className: "modify-title"
      }, _react.default.createElement("p", null, "Modify Car Owner")), _react.default.createElement("div", {
        className: "modify"
      }, this.renderInput(this.refKey, data.Key), this.renderInput(this.refCol, data.Record.color), this.renderInput(this.refDoc, data.Record.docType), this.renderInput(this.refMake, data.Record.make), this.renderInput(this.refModel, data.Record.model), this.renderInput(this.refOwner, data.Record.owner, false)), _react.default.createElement("div", {
    ...
    key: "renderInput",
    value: function renderInput(ref, value) {
      var disabled = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      var c = disabled ? '' : 'can-modify';
      return _react.default.createElement("div", null, _react.default.createElement("input", {
        type: "text",
        className: "modify-input ".concat(c),
        ref: ref,
        placeholder: value,
        disabled: disabled
      }));
    ...
    value: function onClick() {
      ...
      var newOwner = this.refOwner.current.value;
      if (!newOwner) return;

      var handler = function handler(response) {
        var result = response.data.result;
        if (result) window.eventMgr.dispatch(_macro.MacroEvent.UpdateData);
      };

      _network.default.put('/api/changeowner', {
        key: key,
        newOwner: newOwner
      }, handler);
    }
...
exports.default = _default;
},{"react":"../../node_modules/react/index.js","./macro":"../src/macro.js","./network":"../src/network.js"}],"../src/entry.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        className: "entry"
      }, !this.state.receServer ? this.renderWait() : !this.state.adminExists ? this.renderAdmin() : !this.state.user1Exists ? this.renderUser1() : _react.default.createElement(_operation.default, null));
    }
  }, {
    key: "renderWait",
    ...
    value: function renderAdmin() {
      return _react.default.createElement("div", {
        className: "e-admin card shadow"
      }, _react.default.createElement("p", null, "Genernate ", _react.default.createElement("span", {
        className: "highlight"
      }, "Admin"), " cetificate"), _react.default.createElement("button", {
        className: "card-btn",
        onClick: this.genAdmin.bind(this)
      }, "Gen"));
    }
  }, {
    key: "renderUser1",
    value: function renderUser1() {
      return _react.default.createElement("div", {
        className: "e-user card shadow"
      }, _react.default.createElement("p", null, "Genernate ", _react.default.createElement("span", {
        className: "highlight"
      }, "User1"), " cetificate"), _react.default.createElement("button", {
        className: "card-btn btn-green",
        onClick: this.genUser.bind(this)
      }, "Gen"));
    }
  }, {
    key: "getBaseInfo",
    value: function getBaseInfo() {
      ...
      _network.default.get('/api/base', handler);
    }
  }, {
    key: "genAdmin",
    value: function genAdmin() {
      var _this3 = this;
      ...
      _network.default.put('/api/genadmin', {}, handler);
    }
  }, {
    key: "genUser",
    value: function genUser() {
      var _this4 = this;
      ...
      _network.default.put('/api/genuser', {}, handler);
    }
  }]);
...
var _default = Entry;
exports.default = _default;
},{"react":"../../node_modules/react/index.js","axios":"../../node_modules/axios/index.js","./operation":"../src/operation.js","./network":"../src/network.js"}],"../src/lib/event-mgr.js":[function(require,module,exports) {
"use strict";
...
window.eventMgr = new _eventMgr.default();

_reactDom.default.render(_react.default.createElement(_entry.default, null), document.getElementById('root'));
},{"react":"../../node_modules/react/index.js","react-dom":"../../node_modules/react-dom/index.js","./entry":"../src/entry.js","./lib/event-mgr":"../src/lib/event-mgr.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
